...
const UpdateSong=(index)=>{
  ...
  emits('UpdateSong',Songs.value[index].id);
}
      ...
      <tr class="text-white rounded-md"
        ...
        <td>
          <div class="inline pr-4" @click="DeleteSong(index)">
            <svg class="icon fill-red-600 hover:fill-red-800 inline" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"
                 width="24" height="24">
              <path
          ...
          <svg class="icon fill-white inline hover:fill-gray-500" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"
